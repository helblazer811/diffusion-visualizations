...
def train(model, data, num_iterations=1000, batch_size=32, learning_rate=1e-4, device='cpu'):
    ...
    for i in tqdm(range(num_iterations)):
        ...
        if i % 10000 == 0:
            ...
            samples = model.sample(num_samples=500, num_timesteps=200, device=device)
...
if __name__ == "__main__":
    ...
    train(model, spiral_data, num_iterations=1000000, batch_size=32, learning_rate=1e-3, device='cpu')
    # Save the state dict
